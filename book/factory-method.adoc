...
.ConcreteFactory 类
----
include::{source_dir}/factory-method/ConcreteFactory.java[]
----
...
.ConcreteProduct 类
----
include::{source_dir}/factory-method/ConcreteProduct.java[]
----
...
.Factory 类
----
include::{source_dir}/factory-method/Factory.java[]
----
...
.Product 类
----
include::{source_dir}/factory-method/Product.java[]
----
