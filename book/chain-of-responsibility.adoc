...
.Client 类
----
include::{source_dir}/chain-of-responsibility/Client.java[]
----
...
.ConcreteHandler1 类
----
include::{source_dir}/chain-of-responsibility/ConcreteHandler1.java[]
----
...
.ConcreteHandler2 类
----
include::{source_dir}/chain-of-responsibility/ConcreteHandler2.java[]
----
...
.Handler 类
----
include::{source_dir}/chain-of-responsibility/Handler.java[]
----
