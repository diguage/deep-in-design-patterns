...
[[src-proxy-performanceinvocationhandler]]
----
...
[[src-proxy-asm-timestatmethodadapter]]
----
...
[[src-proxy-asm-timestatclassadapter]]
----
...
[[src-proxy-asm-timestatweavegenerator]]
----
...
[[src-proxy-asm-runtimemainaftergen]]
----
...
[source,{java_source_attr}]
.proxy/bytebuddy/ProfilerAdvice.java 类
[[src-proxy-bytebuddy-runtimemainaftergen]]
----
include::{source_dir}/proxy/bytebuddy/ProfilerAdvice.java[]
----

[source,{java_source_attr}]
.proxy/bytebuddy/ByteBuddyTimeStatAgent.java 类
[[src-proxy-bytebuddy-bytebuddytimestatagent]]
----
include::{source_dir}/proxy/bytebuddy/ByteBuddyTimeStatAgent.java[]
----
